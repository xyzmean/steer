...
CORE_SRC := src/lib/run.c src/lib/jsonw.c src/compile/groups.c src/compile/generate.c src/compile/ir.c src/compile/print.c src/compile/legacy.c src/daemon/fwcheck.c \
            ...
            src/daemon/conns.c src/daemon/loop.c src/daemon/state.c $(KINDS_BASE_SRC)
