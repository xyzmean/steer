 ...
 *
 * ZAPRET_SKIP_MARK мы СТАВИМ САМИ на трафик выхода kind=zapret, и это единственный способ
 * сказать системному обходу «этот трафик не твой»: его цепочка входит по условию
 * `meta mark & 0x40000000 == 0`. Иначе трафик разбирали бы двое — сначала общий обход своей
 * стратегией, потом наш экземпляр своей, — и вышло бы не то, что выбрал человек, ни в одном
 * из двух смыслов. Проверить это глазами нельзя: правила у обоих выглядят исправно.
 *
