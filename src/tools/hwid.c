/* Идентификатор роутера и описание устройства. Разбор — в src/tools/hwid.h.
 *
 * ФАЙЛ ПЕРЕЕХАЛ СЮДА ИЗ src/proto/vless/subfetch.c БЕЗ ЕДИНОГО ИЗМЕНЕНИЯ ШАГА ВЫЧИСЛЕНИЯ, и это
