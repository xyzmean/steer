 ...
 *
 * Выбор шифра при этом НЕ наш: его называет сервер из списка в нашем ClientHello, а список
 * обязан совпадать с браузерным — в этом весь смысл Reality. Поставить ChaCha первой, чтобы
 * выиграть на слабом железе, значит изменить отпечаток и стать заметным; поэтому ускоряем то,
 * что выберут, а не выбираем то, что быстрее.
 *
