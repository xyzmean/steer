...
{"srs-read", "Списки", "<файл.srs>",
 ...
 "itdoginfo/allow-domains текстовых файлов нет ни одного. Команда печатает содержимое\n"
 ...
 "\n"
 "Набор, который понят, но не выразим списком, отвергается целиком с кодом 2 и строкой,\n"
 "называющей причину: правило с invert, source_ip_cidr, логические правила «и»/«или»,\n"
 "условия про процессы, пакеты и Wi-Fi.",
