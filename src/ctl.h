/* Управляющий сокет движка: сервер (`steer ctl-serve`) и клиент для отладки (`steer ctl`).
 *
 * Протокол, доводы и пределы описаны в шапке src/ctl.c и в docs/ctl.md; здесь только точки
