 ...
 * добавил память сторожа (outs), шаг 4 — таблицу детей (sup). Что применено в ядро (шаг 5,
 * apply-сверка) держит сервер сокета (struct recon_state в ctl.c, recon.h): применяет только он.
 *
