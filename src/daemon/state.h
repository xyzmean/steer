 ...
 * перечитанные после apply/reload, пути, с которыми демон запущен, и подписчики событий. Шаги
 * 3-5 добавят сюда состояние выходов (активное устройство, серия, здоровье), таблицу детей и
 * применённый ruleset — полями этой же структуры, а не глобалами.
 *
