...
[ -x "$BIN" ] || {
    ...
    echo "           src/daemon/steer.c src/model/spec.c src/daemon/failover.c src/tools/aggregate.c \\"
    echo "           src/lib/sindex.c src/lib/nftnl.c src/lib/ctnl.c \\"
    echo "           src/dnsd/rules.c src/dnsd/wire.c src/dnsd/fakeip.c src/dnsd/table.c src/dnsd/dlog.c src/dnsd/proxy.c src/dnsd/main.c \\"
