...
# ответ приходит с его адреса; down снимает цепочки выхода. Устройства — постоянные TUN (local49-tool mk), «сеть» — up0 с
...
local49-tool serve6 53 fd66::53 203.0.113.78 & U6=$!
sleep 0.5
