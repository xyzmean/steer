...
# архиве, а отсутствующий список не мешает применению (H-012) и восстанавливается по
# расписанию. Решение владельца — splicicd#6; проверка стоит на том, чтобы каталог не
# попал туда «заодно», без этого решения.
