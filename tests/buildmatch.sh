...
#
# srs.c: двадцать строк, и все двадцать — отказы РАЗОБРАТЬ набор. Команда `srs-read` в этих
...
check "голых «steer: » ровно столько, сколько отказов вызывающему" "src/steer.c:5 src/srs.c:20 " "$bare"
